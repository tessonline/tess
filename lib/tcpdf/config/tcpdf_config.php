 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'T-MAPY spol. s r.o.');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Ondrej Maly');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Elektronicka evidence dokumentu');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by OnMa - www.tmapy.cz");
