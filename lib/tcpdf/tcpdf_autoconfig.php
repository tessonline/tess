...
if (!defined('K_PATH_CACHE')) {
	$K_PATH_CACHE = ini_get('upload_tmp_dir') ? ini_get('upload_tmp_dir') : '/tmp/';
...
if (!function_exists('array_fill_keys')) {
  function array_fill_keys(array $array, $values) {
//       if(is_array($array)) {
...
//       }
       if (count($array)>0)
         $arraydisplay = array_combine($array,array_fill(0,count($array),$values));
       else
         $arraydisplay = array(0 => $values);
      return $arraydisplay;
  }
}
