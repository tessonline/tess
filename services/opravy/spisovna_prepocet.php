...
//    echo "$celkem x $pocitadlo - ";
    ...
    if ($q->Record['LISTU']<>$pocet_listu_celkem)
    {
     echo $q->Record['ID']." - čj. ".$q->Record["CISLO_SPISU1"]." - listu ".$q->Record['LISTU']." -nove ".$pocet_listu_celkem."<br/>";
     $sql="update posta_spisovna set listu=".$pocet_listu_celkem." where id=".$spisovna_id;
     $b->query($sql);
    }
}
