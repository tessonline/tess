...
$sqla = ' select id,referent,odbor from posta where odbor in (select id from cis_posta_odbory where id_odbor not in (select id from security_group)) and status>1';
