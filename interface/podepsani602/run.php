...
<input type="hidden" name="SCHVALENO" value="'.$SCHVALENO.'">
	...
	<OBJECT ID="PDFSigner" CLASSID="CLSID:CC503770-F4F5-4A8D-8B5C-4CBAF8343583" VIEWASTEXT><font color=red>Chyba inicializace ActiveX komponenty PDFSigner!<br/>Je nutno používat Internet Explorer a nainstalovat si tento doplněk <a href="PDFSigner.msi">PDFSigner.msi</a><br/><br/></font></OBJECT>
';
require_once(Fileup2("html_footer.inc"));  
echo '
<script language="javascript">
	...
	function SignFile()
	{
		...
		PDFSigner.AddTimeStamp = '.$GLOBALS['TIMESTAMP'].';
