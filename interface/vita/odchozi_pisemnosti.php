...
// SQL dotaz
    $q=new DB_POSTA;
    $sql = "SELECT * FROM posta WHERE odbor = '".$a_odbor."'";
    if ($a_prac) $sql.=" AND referent = '".$a_prac."'";
    if ($a_idod) $sql.=" AND id > '".$a_idod."'";
    $sql.=" AND odeslana_posta='t' order by id;";
...
//      echo "    <b_uvp>".$q->Record["UVP"]."</b_uvp>\n";
      ...
      echo "    <b_doruceno>".$q->Record["DATUM_DORUCENI"]."</b_doruceno>\n";
