 ...
 *  Author: Ale Roubíček -rarous- (rarous@seznam.cz)
 *
 */
...
$ns = "http://texy.info"; // prostor názvů sluby

$server = new soap_server();
$server->configureWSDL('TexyConverter', $ns); // název webové sluby
...
// input boolean trust  má Texy! pracovat v důvěryhodném reimu nebo v bezpečném
// input integer headingLevel  nejvyí úroveň nadpisu
// return string html  vrací XHTML kód
