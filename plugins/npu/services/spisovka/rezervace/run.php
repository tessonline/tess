...
$values=array($superodbor,Date('Y'),'t',Date('d.m.Y h:i'),$GLOBALS['CONFIG']['REZERVACE_TYP_POSTY'],'Z',$id_user,'X','4',$OWNER_ID,$OWNER_ID,$LAST_DATE,$LAST_TIME,$GLOBALS['ODBOR'],$GLOBALS['ODDELENI'],'rezervace čj.','9');
